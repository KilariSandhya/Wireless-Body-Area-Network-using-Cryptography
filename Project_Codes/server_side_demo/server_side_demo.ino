...
String string3 = String("Temp:88'F ");
String string4 = String("Pulse:88bpm ");
...
void loop() {
  ...
  int sr_len0=encrypted0.length()+1;
  encrypted0.toCharArray(ciphertext0,sr_len0);
  String decrypted0 = decrypt(ciphertext0, dec_iv); 
  Serial.println(decrypted0);
  delay(15000);
}
